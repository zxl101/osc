...
aircraft_root = '/media/neuron/Elements/Dataset/fgvc-aircraft-2013b'
...
def get_aircraft_datasets(train_transform, test_transform, train_classes=range(60), auxiliary_classes=range(60,80),
                       open_set_classes=range(80, 100), balance_open_set_eval=False, split_train_val=True, seed=0):
    ...
    if auxiliary_classes is not None:
        ...
        aux_dataset_known = subsample_classes(train_dataset_whole, include_classes=auxiliary_classes)
