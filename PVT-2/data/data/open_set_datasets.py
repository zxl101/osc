...
def get_class_splits(dataset, split_idx=0, cifar_plus_n=10):
    ...
    if dataset in ('cifar-10-10', 'mnist', 'svhn'):
        ...
        auxiliary_classes = range(100,150)
        ...
        train_classes = range(60)
        auxiliary_classes = range(60,80)
        open_set_classes = range(80, 100)
    ...
    return train_classes, auxiliary_classes, open_set_classes
