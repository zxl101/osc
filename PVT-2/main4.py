...
from engine import train_one_epoch, train_one_epoch_aux, evaluate
...
def get_args_parser():
    ...
    parser.add_argument('--epochs', default=300*2, type=int)
    ...
    parser.add_argument('--decay-epochs', type=float, default=30*2, metavar='N',
                        help='epoch interval to decay LR')
    parser.add_argument('--warmup-epochs', type=int, default=5*2, metavar='N',
                        help='epochs to warmup LR, if scheduler supports')
    parser.add_argument('--cooldown-epochs', type=int, default=10*2, metavar='N',
                        help='epochs to cooldown LR at min_lr, after cyclic schedule ends')
    parser.add_argument('--patience-epochs', type=int, default=10*2, metavar='N',
